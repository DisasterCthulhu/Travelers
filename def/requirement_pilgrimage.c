...
void configure() {
    ...
    set_requirement_bonus_bestowals(({
        "great experience",
    }));
    ...
    set_requirement_initialize_process((:
        ...
        mapping destinations = ([
            Crystal_Caves_Room("map_0_-1_4")                                    : Rarity_Very_Common,
            Obsidia_Room("statue")                                                : Rarity_Very_Common,
        ...
        Temple_of_Ganesha_Daemon("control")->temple_of_ganesha_move_temple(0, who);
        return;
    :));
