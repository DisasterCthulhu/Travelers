...
void travelers_taboo_shouting_do_speak(descriptor dxr) {
...
void configure() {
	...
	set_taboo_initialize_description("shouting");
	set_taboo_overcome_description("shouting");
	...
	add_taboo_hook(Do_Speak, #'travelers_taboo_shouting_do_speak);
}
