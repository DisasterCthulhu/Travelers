...
nosave private descriptor violation_message;
...
nomask descriptor query_taboo_violation_message() {
    return violation_message ||= Message(([
        Message_Content                         : ({
...
nomask void taboo_violation(object obj) {
    obj->ganesha_challenge_query_owner()->display(query_taboo_violation_message());
